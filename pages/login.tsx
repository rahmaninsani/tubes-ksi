...
export default function LoginPage() {
  ...
  return (
    <section className="mx-4 flex h-screen flex-col items-center justify-center lg:mx-0 lg:flex-row">
      <Link
        href="/"
      ...
      <div className="hidden w-full flex-col items-center justify-center lg:block">
        <Image
